# Octii.py [![Maintenance](https://img.shields.io/badge/Maintained%3F-no%20:D-red.svg)](https://GitHub.com/Picoseconds/octii-py/graphs/commit-activity)
I had to write this within seconds because Interim wants my selfbot NOW

## Features
I don't know, you can probably read api.py and the example (I am adding features as my own selfbot "for interim" needs them)
...
## Project Scope
The goal of the Octii.py project is to create a Python self-bot client for Octii that tries to be easy to use like discord.py. Think of Discord when it was good
